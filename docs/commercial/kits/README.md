# Kits de implantación — Migajas

Materiales para repartir en centros de salud, enviar por email o imprimir en recepción / sala de espera.

| Kit | Audiencia | Archivo |
|-----|-----------|---------|
| **Paciente** | Personas en educación diabetológica (y familiares) | [KIT-PACIENTE.md](./KIT-PACIENTE.md) |
