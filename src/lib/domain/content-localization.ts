...
const FOOD_REGION_ALIASES: Record<string, Record<string, string>> = {
  ...
  "es-sandwich-mixto": { do: "do-pan-agua" },
  manzana: { do: "mango" },
  leche: { do: "leche-do" },
  ...
  calabaza: { do: "do-ayote" },
  zanahoria: { do: "do-ayote" },
  "tortilla-patata": { do: "mangu" },
  bocadillo: { do: "do-pan-agua" },
  paella: { do: "moro-habichuelas" },
  pizza: { do: "la-bandera" },
  pollo: { do: "pollo-do" },
  pescado: { do: "do-pescado-frito" },
  carne: { do: "pollo-do" },
  huevo: { do: "do-huevo-do" },
  "lentejas-estofadas": { do: "la-bandera" },
  "pan-integral": { do: "do-pan-agua" },
  naranja: { do: "chinola" },
  "couscous-cocido": { do: "arroz-blanco-do" },
  "patata-frita": { do: "tostones" },
  "barra-pequena": { do: "do-pan-agua" },
  tomate: { do: "do-repollo" },
  fresas: { do: "mango" },
  pera: { do: "mango" },
  "pasta-tomate": { do: "moro-habichuelas" },
  "leche-media": { do: "leche-do" },
  "aceite-oliva": { do: "do-aceite" },
  "es-agua": { do: "do-agua" },
};
...
> = {
  ...
  "l2-1-s1:do:body": {
    body: "El arroz, la yuca y el plátano se miden ya cocidos. Un tercio de taza suele acercarse a 15 gramos de carbohidratos = 1 ración aquí.",
  },
  ...
  "l3-1-s2:do:body": {
    body: "Media taza de habichuelas rojas (100 g) tiene unos 23 gramos de carbohidratos = 1,5 raciones. En República Dominicana se divide entre 15, no entre 10.",
  },
  ...
  "l4-1-s2:do:body": {
    body: "El mangú lleva plátano (carbohidratos) y huevo (casi no suma). Media taza (~100 g) tiene unos 31 gramos de carbohidratos = 2 raciones.",
  },
